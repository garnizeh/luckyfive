...
import (
	...
	services "github.com/garnizeh/luckyfive/internal/services"
...
func (m *MockSimulationServicer) CreateSimulation(ctx context.Context, req services.CreateSimulationRequest) (*simulations.Simulation, error) {
	m.ctrl.T.Helper()
